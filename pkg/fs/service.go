...
// DriveResolver provides a way to resolve the active drive ID.
type DriveResolver interface {
	// GetActiveDriveID returns the identifier for the currently active drive.
	GetActiveDriveID(ctx context.Context) (string, error)
}
