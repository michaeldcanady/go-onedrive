...
- **Do NOT use for**: Implementing the core feature logic (`software-engineer`), designing the public API structure (`ux-engineer`), or managing the product roadmap (`product-manager`).
