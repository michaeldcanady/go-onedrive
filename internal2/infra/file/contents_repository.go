...
func NewGraphFileContentsGateway(client abstractions.RequestAdapter, l logger.Logger) *GraphFileContentsGateway {
...
func (g *GraphFileContentsGateway) Upload(ctx context.Context, driveID, path string, data []byte, ifMatch string) (*file.Metadata, string, error) {
