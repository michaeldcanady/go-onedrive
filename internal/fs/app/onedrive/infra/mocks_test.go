...
func (m *MockContentsCache) Get(ctx context.Context, id string) (*domain.Contents, bool) {
	args := m.Called(ctx, id)
	if args.Get(0) == nil {
		return nil, args.Bool(1)
	}
	return args.Get(0).(*domain.Contents), args.Bool(1)
}

func (m *MockContentsCache) Put(ctx context.Context, id string, c *domain.Contents) error {
...
func (m *MockMetadataCache) Get(ctx context.Context, id string) (*domain.Metadata, bool) {
	args := m.Called(ctx, id)
	if args.Get(0) == nil {
		return nil, args.Bool(1)
	}
	return args.Get(0).(*domain.Metadata), args.Bool(1)
}

func (m *MockMetadataCache) Put(ctx context.Context, path string, meta *domain.Metadata) error {
...
func (m *MockListingCache) Get(ctx context.Context, path string) (*domain.Listing, bool) {
	args := m.Called(ctx, path)
	if args.Get(0) == nil {
		return nil, args.Bool(1)
	}
	return args.Get(0).(*domain.Listing), args.Bool(1)
}

func (m *MockListingCache) Put(ctx context.Context, path string, l *domain.Listing) error {
