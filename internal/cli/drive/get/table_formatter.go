...
var (
	driveIDColumn       = NewColumn("ID", func(item *domaindrive.Drive) string { return item.ID })
	driveNameColumn     = NewColumn("Name", func(item *domaindrive.Drive) string { return item.Name })
	driveTypeColumn     = NewColumn("Type", func(item *domaindrive.Drive) string { return string(item.Type) })
	driveOwnerColumn    = NewColumn("Owner", func(item *domaindrive.Drive) string { return string(item.Owner) })
	driveReadOnlyColumn = NewColumn("ReadOnly", func(item *domaindrive.Drive) string { return strconv.FormatBool(item.ReadOnly) })
)
