...
func setupTestEnv(t *testing.T) {
	tmpDir := t.TempDir()
	os.Setenv(infra.EnvConfigDir, tmpDir)
	os.Setenv(infra.EnvCacheDir, tmpDir)
	os.Setenv(infra.EnvDataDir, tmpDir)
	os.Setenv(infra.EnvLogDir, tmpDir)
	os.Setenv(infra.EnvStateDir, tmpDir)
}
