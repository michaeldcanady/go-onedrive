...
// Options defines the configuration for the mv command.
// It encapsulates the source and destination paths and standard I/O streams.
type Options struct {
	// Source is the current OneDrive path of the item to be moved or renamed.
	Source string

	// Destination is the new OneDrive path for the item.
	Destination string
