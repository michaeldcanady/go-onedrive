...
import (
	...
	domainenvironment "github.com/michaeldcanady/go-onedrive/internal/core/env/domain"
...
var _ domaineditor.Launcher = (*Launcher)(nil)

// Launcher implements domaineditor.Launcher using os/exec.
...
func NewLauncher(envSvc domainenvironment.EnvironmentService, l domainlogger.Logger) *Launcher {
	return &Launcher{
		envSvc: envSvc,
		log:    l,
		stdin:  os.Stdin,
...
func (l *Launcher) WithIO(stdin io.Reader, stdout, stderr io.Writer) domaineditor.Launcher {
	l.stdin = stdin
	l.stdout = stdout
	l.stderr = stderr
	return l
