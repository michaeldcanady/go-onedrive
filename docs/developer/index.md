...
`odc` builds using a **Vertical Slice Architecture**, which organizes code by features rather than layers. This approach makes it easier to add new commands and maintain existing ones without navigating complex, cross-cutting layers
...
- **[Configuration Management](explanation/configuration-management.md):** How user settings and application state handle
...
- **[Testing Standards](recommendations/01-improve-test-coverage.md):** How to write and run unit and integration tests
